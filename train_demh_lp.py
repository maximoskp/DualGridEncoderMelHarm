...
def main():
    ...
    os.makedirs('results/DE_lp/' + subfolder + '/', exist_ok=True)
    results_path = 'results/DE_lp/' + subfolder + '/' + curriculum_type + '.csv'

    os.makedirs('saved_models/DE_lp/', exist_ok=True)
    os.makedirs('saved_models/DE_lp/' + subfolder + '/', exist_ok=True)
    save_dir = 'saved_models/DE_lp/' + subfolder + '/'
