...
def main():
    ...
    grid_length = int(subfolder.split('_L')[1].split('_')[0])
    tokenizer = CSGridMLMTokenizer(
        fixed_length=grid_length,
    ...
    # save results
    os.makedirs('results/SE4/', exist_ok=True)
    os.makedirs('results/SE4/' + subfolder + '/', exist_ok=True)
    results_path = 'results/SE4/' + subfolder + '/' + curriculum_type + '.csv'

    os.makedirs('saved_models/SE4/', exist_ok=True)
    os.makedirs('saved_models/SE4/' + subfolder + '/', exist_ok=True)
    save_dir = 'saved_models/SE4/' + subfolder + '/'
