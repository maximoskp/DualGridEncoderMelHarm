...
from models import DE_only_cross
import torch
...
def main():
    ...
    # save results
    os.makedirs('results/DE_cross/', exist_ok=True)
    os.makedirs('results/DE_cross/' + subfolder + '/', exist_ok=True)
    results_path = 'results/DE_cross/' + subfolder + '/' + curriculum_type + '.csv'

    os.makedirs('saved_models/DE_cross/', exist_ok=True)
    os.makedirs('saved_models/DE_cross/' + subfolder + '/', exist_ok=True)
    save_dir = 'saved_models/DE_cross/' + subfolder + '/'
