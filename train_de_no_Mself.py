...
from models import DE_no_Mself
import torch
...
def main():
    ...
    # save results
    os.makedirs('results/DE_no_Mself/', exist_ok=True)
    os.makedirs('results/DE_no_Mself/' + subfolder + '/', exist_ok=True)
    results_path = 'results/DE_no_Mself/' + subfolder + '/' + curriculum_type + '.csv'

    os.makedirs('saved_models/DE_no_Mself/', exist_ok=True)
    os.makedirs('saved_models/DE_no_Mself/' + subfolder + '/', exist_ok=True)
    save_dir = 'saved_models/DE_no_Mself/' + subfolder + '/'
