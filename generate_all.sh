...
scripts=(
    ...
    # "generate_order_test.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -r start"
    # "generate_order_test.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -r end"
    # "generate_order_test.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -r random"
    # "generate_order_test.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -r certain"
    # "generate_order_test.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -r uncertain"
    # "generate_order_test.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -v 0 -r start"
    # "generate_order_test.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -v 0 -r end"
    # "generate_order_test.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -v 0 -r random"
    # "generate_order_test.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -v 0 -r certain"
    # "generate_order_test.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -v 0 -r uncertain"
    ...
    "generate_order_jazz.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -r start"
    "generate_order_jazz.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -r end"
    "generate_order_jazz.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -r random"
    "generate_order_jazz.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -r certain"
    "generate_order_jazz.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -r uncertain"
    "generate_order_jazz.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -v 0 -r start"
    "generate_order_jazz.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -v 0 -r end"
    "generate_order_jazz.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -v 0 -r random"
    "generate_order_jazz.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -v 0 -r certain"
    "generate_order_jazz.py -m DE -c f2f -f Q4_L80_bar_PC -g nucleus -u 1 -v 0 -r uncertain"
)
