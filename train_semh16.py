...
def main():
    ...
    # save results
    os.makedirs('results/SE16/', exist_ok=True)
    os.makedirs('results/SE16/' + subfolder + '/', exist_ok=True)
    results_path = 'results/SE16/' + subfolder + '/' + curriculum_type + '.csv'

    os.makedirs('saved_models/SE16/', exist_ok=True)
    os.makedirs('saved_models/SE16/' + subfolder + '/', exist_ok=True)
    save_dir = 'saved_models/SE16/' + subfolder + '/'
