...
def main():
    ...
    # save results
    os.makedirs('results/DE4/', exist_ok=True)
    os.makedirs('results/DE4/' + subfolder + '/', exist_ok=True)
    results_path = 'results/DE4/' + subfolder + '/' + curriculum_type + '.csv'

    os.makedirs('saved_models/DE4/', exist_ok=True)
    os.makedirs('saved_models/DE4/' + subfolder + '/', exist_ok=True)
    save_dir = 'saved_models/DE4/' + subfolder + '/'
