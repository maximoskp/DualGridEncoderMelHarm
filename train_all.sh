...
scripts=(
    ...
    # "train_semh.py -c base2 -f Q16_L320_bar_PC_FR -d /media/maindisk/data/hooktheory_midi_hr/CA_train -v /media/maindisk/data/hooktheory_midi_hr/CA_test -g 0 -e 200 -l 1e-4 -b 8"
