...
#     "train_art_semh.py -c f2f -f Q4_L80_bar_PC -d /media/maindisk/data/synthetic_CA_train -v /media/maindisk/data/synthetic_CA_test -g 0 -e 200 -l 1e-4 -b 8"
    ...
    # 4-16 layers
    # "train_demh4.py -f Q4_L80_bar_PC -d /media/maindisk/data/hooktheory_midi_hr/CA_train -v /media/maindisk/data/hooktheory_midi_hr/CA_test -g 0 -e 200 -l 5e-5 -b 8"
    # "train_semh16.py -c f2f -f Q4_L80_bar_PC -d /media/maindisk/data/hooktheory_midi_hr/CA_train -v /media/maindisk/data/hooktheory_midi_hr/CA_test -g 0 -e 200 -l 5e-5 -b 8"
