...
def main():
    ...
    # save results
    os.makedirs('results/SE_v0/', exist_ok=True)
    os.makedirs('results/SE_v0/' + subfolder + '/', exist_ok=True)
    results_path = 'results/SE_v0/' + subfolder + '/' + curriculum_type + '.csv'

    os.makedirs('saved_models/SE_v0/', exist_ok=True)
    os.makedirs('saved_models/SE_v0/' + subfolder + '/', exist_ok=True)
    save_dir = 'saved_models/SE_v0/' + subfolder + '/'
