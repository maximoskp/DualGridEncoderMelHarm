...
def main():
    ...
    os.makedirs('results/SE/art_' + subfolder + '/', exist_ok=True)
    results_path = 'results/SE/art_' + subfolder + '/' + curriculum_type + '.csv'

    os.makedirs('saved_models/SE/', exist_ok=True)
    os.makedirs('saved_models/SE/art_' + subfolder + '/', exist_ok=True)
    save_dir = 'saved_models/SE/art_' + subfolder + '/'
