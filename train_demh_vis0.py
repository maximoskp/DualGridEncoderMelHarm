...
def main():
    ...
    # save results
    os.makedirs('results/DE_v0/', exist_ok=True)
    os.makedirs('results/DE_v0/' + subfolder + '/', exist_ok=True)
    results_path = 'results/DE_v0/' + subfolder + '/' + curriculum_type + '.csv'

    os.makedirs('saved_models/DE_v0/', exist_ok=True)
    os.makedirs('saved_models/DE_v0/' + subfolder + '/', exist_ok=True)
    save_dir = 'saved_models/DE_v0/' + subfolder + '/'
