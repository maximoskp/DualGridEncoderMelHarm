...
if __name__ == "__main__":
    ...
    root_folder       = "./MIDIs_order/order_super"   # folder containing setups; each setup has instance folders
    ...
    compute_and_save_html_results_by_setup(
        ...
        melody_track_index=0,
        grouping_threshold=0.05,
        output_html="results/results_order2_test.html"
    )

    ground_truth_path = "./MIDIs_jazz/real"          # folder with the ground-truth MIDIs
    root_folder       = "./MIDIs_jazz_order/order_super"   # folder containing setups; each setup has instance folders
    ...
    compute_and_save_html_results_by_setup(
        ...
        melody_track_index=0,
        grouping_threshold=0.05,
        output_html="results/results_order2_jazz.html"
    )